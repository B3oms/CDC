...
<div class="beneficiaries-page">
    <div class="page-header">
        <div>
            <h1>Beneficiaries</h1>
            <p class="page-sub">View beneficiaries registered in your barangay</p>
        </div>
    </div>
    ...
    <div class="stats-grid">
        <div class="stat-item">
            <span class="stat-value" style="color: #1a3d1f;">{{ $stats['total'] }}</span>
            <span class="stat-desc">Total Beneficiaries</span>
        </div>
        <div class="stat-item">
            <span class="stat-value" style="color: #059669;">{{ $stats['verified'] }}</span>
            <span class="stat-desc">Verified</span>
        </div>
        <div class="stat-item">
            <span class="stat-value" style="color: #d97706;">{{ $stats['pending'] }}</span>
            <span class="stat-desc">Pending Verification</span>
        </div>
        <div class="stat-item">
            <span class="stat-value" style="color: #dc2626;">{{ $stats['high_vulnerability'] }}</span>
            <span class="stat-desc">High Vulnerability</span>
        </div>
    </div>

    {{-- FILTERS --}}
    <div class="filters-card">
        <form method="GET" action="{{ route('barangay.beneficiaries.index') }}" class="filters-form">
            ...
            <div class="filter-group">
                ...
                <select name="is_4ps_member" class="filter-select" onchange="this.form.submit()">
                    <option value="">All</option>
            ...
            <div class="filter-actions">
                <a href="{{ route('barangay.beneficiaries.index') }}" class="btn-filter-reset">
            ...
            <table class="modern-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('barangay.beneficiaries.show', $b->id) }}" class="btn-view">View</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="10" class="td-empty">No beneficiaries found in your barangay.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
