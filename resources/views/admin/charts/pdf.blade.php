...
<body>
    <div class="header">
        <h1>{{ $title }} <span class="admin-badge">ADMIN</span></h1>
        <div class="subtitle">Generated on {{ now()->format('F d, Y H:i:s') }} | Administrative Report</div>
    </div>
    ...
    <div class="footer">
        ...
        <p>Administrative Chart Analysis Report - {{ $title }}</p>
