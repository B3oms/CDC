...
<head>
    ...
    <style>
        ...
        .admin-badge { background-color: #1a3d1f; color: white; padding: 2px 8px; font-size: 9px; font-weight: bold; text-transform: uppercase; margin-left: 8px; }
...
<body>
    ...
    <table class="header-tbl">
        <tr>
            <td style="vertical-align: middle;">
                ...
                <div style="font-size: 19px; font-weight: bold; color: #1a3d1f;">{{ $title }} <span class="admin-badge">Admin</span></div>
                <div style="font-size: 10px; color: #9ca3af; margin-top: 2px;">Administrative Chart Analysis &bull; Generated: {{ now()->format('F d, Y H:i:s') }}</div>
            </td>
    ...
    <div class="interpretation-section">
        <h2>Administrative Chart Analysis & Interpretation</h2>
        ...
        <div class="interpretation-item">
            <strong>Peak Activity Analysis</strong>
    ...
    <div class="footer">
        ...
        Administrative Chart Analysis Report &bull; This is a system-generated document
    </div>
</body>
</html>
