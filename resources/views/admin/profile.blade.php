            ...
            <div class="profile-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <p class="info-value">{{ $user->birthdate ? $user->birthdate->format('M d, Y') : 'Not set' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="profile-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <p class="info-value">{{ $user->role->name ?? 'Admin' }}</p>
                    </div>
                    <div class="info-item">
            ...
            <form method="POST" action="{{ route('admin.profile.update') }}">
                ...
                <div class="profile-section">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            <p class="info-label">Birthdate</p>
                            <input type="date" name="birthdate" value="{{ $user->birthdate ? $user->birthdate->format('Y-m-d') : '' }}" class="form-input">
                        </div>
                    </div>
                </div>
