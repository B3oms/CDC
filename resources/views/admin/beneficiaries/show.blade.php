    ...
    <div class="yearly-col">
        ...
        <div class="section-card">
            ...
            <table class="dist-table">
                ...
                <tr><td class="meta-label">Full Name</td>
                    <td>{{ $beneficiary->first_name }} {{ $beneficiary->middle_name }} {{ $beneficiary->last_name }} {{ $beneficiary->suffix ?? '' }}</td></tr>
                <tr><td class="meta-label">Gender</td>
                    <td>{{ $beneficiary->gender }}</td></tr>
                <tr><td class="meta-label">Age</td>
                    <td>{{ $beneficiary->age ?? 'N/A' }} years old</td></tr>
