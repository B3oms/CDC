...
<div class="beneficiaries-page">
    ...
    <div class="filters-card">
        <form method="GET" action="{{ route('admin.beneficiaries.index') }}" id="filterForm" class="filters-form">
            <div class="filter-group">
                <label class="filter-label">Municipality</label>
                <select name="municipality_id" id="municipality" class="filter-select" onchange="document.getElementById('filterForm').submit()">
            ...
            <div class="filter-actions">
                <a href="{{ route('admin.beneficiaries.pdf', request()->query()) }}" class="btn-filter-action">
            ...
            <table class="modern-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.beneficiaries.show', $b->id) }}" class="btn-view">View</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
