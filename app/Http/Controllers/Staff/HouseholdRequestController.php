...
{
    // Display all household requests for staff/admin
    public function index()
    {
        ...
        return view('staff.household_requests.index', compact('requests', 'statistics'));
    }
    ...
    public function show($id)
    {
        ...
        return view('staff.household_requests.show', compact('request'));
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return redirect()->route('staff.household_requests.show', $id)
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('staff.household_requests.index')
